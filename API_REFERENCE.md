...
| **Conversion**        | [`from_pandas`](#from_pandas) — [`to_pandas`](#to_pandas) — [`to_arrow`](#to_arrow)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
Converts an `ArFrame` into a `pyarrow.Table`.

Supported ArFrame scalar dtypes are mapped to Arrow types where possible:
...
Columns with unsupported ArFrame scalar dtypes fall back to Arrow strings.
